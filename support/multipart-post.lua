--[[
  Multipart form post in Lua is murderously hard.
  This code was lifted from https://github.com/catwell/lua-multipart-post
  So grateful somebody else figured this out...
]]
