jester.help.tracker = {}
jester.help.tracker.description_short = [[Track various states in the channel.]]
jester.help.tracker.description_long = [[This module provides actions assist in tracking various states in a channel.]]

jester.help.tracker.actions = {}

jester.help.tracker.actions.counter = {}
jester.help.tracker.actions.counter.description_short = [[Incremental custom variable counter.]]
jester.help.tracker.actions.counter.description_long = [[This action provides a simple method to keep a count of any arbitrary value, provides access to calling sequences by comparing a number against the total in the counter.  It's useful for storing how many times you've done something, eg. on 3rd failed login attempt, hang up.  Counters are initialized with a value of zero, and placed in storage area 'counter'.]]
jester.help.tracker.actions.counter.params = {
