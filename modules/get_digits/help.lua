...
jester.help_map.get_digits.actions.get_digits.params = {
  min_digits = [[(Optional) The minimum number of digits to collect.  Default is 1.  Alternatively, a string prefixed with a colon can be passed, and the length of the string will be used to set the value.]],
  max_digits = [[(Optional) The maximum number of digits to collect. Default is 10.  Alternatively, a string prefixed with a colon can be passed, and the length of the string will be used to set the value.]],
