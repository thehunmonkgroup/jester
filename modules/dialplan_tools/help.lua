...
jester.help_map.dialplan_tools.actions.bridge.params = {
  channel = [[The channel to use for the bridge.  Can be a string (used for all extensions), or optionally a table of multiple channels (used with the matching extension in the extension list).]],
  extension = [[The extension to bridge to.  Can be a string (used for all channels), or optionally a table of multiple extensions (used with the matching channel in the channel list).]],
